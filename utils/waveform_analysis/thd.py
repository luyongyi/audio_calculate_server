...
from utils.waveform_analysis._common import parabolic, rms_flat
from utils.waveform_analysis.weighting_filters.ABC_weighting import A_weight
...
def THD(signal, fs, *, freq=None, ref='f', verbose=False,num_harm=8):
    """
    ...
    num_harmonics = int(num_harm)
    #print(f"numharm:{num_harmonics}")
    harmonic_amplitudes = []
